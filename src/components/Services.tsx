...
const SERVICES = [
  {
    index: '01',
    title: 'Film Editing',
    short: 'Cutting stories, frame by frame.',
    body: 'Full-spectrum film editing — from assembly and rough cuts to fine-tuning performances. I bring rhythm, pacing, and emotional depth to every project, working in Adobe Premiere Pro, DaVinci Resolve, and Avid Media Composer.',
    keywords: ['Assembly', 'Fine Cut', 'Rhythm & Pacing', 'Adobe Premiere Pro'],
  },
  {
    index: '02',
    title: 'Color Grading & DI',
    short: 'The look and feel of your story.',
    body: 'Professional color grading and digital intermediate services. From primary correction to creative grading, I ensure your film has a cohesive visual language that enhances the narrative and tone.',
    keywords: ['DaVinci Resolve', 'Color Correction', 'Creative Grading', 'DI Conform'],
  },
  {
    index: '03',
    title: 'Sound Design & Mixing',
    short: 'Audio that immerses.',
    body: 'Sound design, dialogue clean-up, background scoring integration, and final mix. Clean, immersive audio that complements the visuals and elevates the storytelling experience.',
    keywords: ['Sound Design', 'Dialogue Editing', 'Ambience', 'Final Mix'],
  },
  {
    index: '04',
    title: 'Trailer & Promo Editing',
    short: 'First impressions that count.',
    body: 'Theatrical trailers, teasers, and promotional content crafted to captivate audiences. I understand the rhythm of marketing and create cuts that sell the story without giving it away.',
    keywords: ['Trailer Editing', 'Teaser', 'Promo', 'Motion Graphics'],
  },
  {
    index: '05',
    title: 'Direction & Creative Supervision',
    short: 'Vision through the lens.',
    body: 'From pre-production planning to post-production oversight, I offer direction services that ensure your project stays true to its creative vision. Script analysis, shot breakdowns, and editorial supervision throughout.',
    keywords: ['Direction', 'Storytelling', 'Script Analysis', 'Editorial Supervision'],
  },
];
