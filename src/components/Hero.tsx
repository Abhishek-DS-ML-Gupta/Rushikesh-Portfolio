...
const STACK_TAGS = ['Adobe Premiere Pro', 'DaVinci Resolve', 'Avid Media Composer', 'Film Editing', 'Direction', 'Storytelling'];
    ...
    >
      ...
      <div className="relative z-10 flex flex-col flex-1 w-full pl-[clamp(1rem,4vw,5rem)] pr-[clamp(1rem,8vw,14rem)]">
        ...
        <div className="flex flex-col flex-1 justify-end pb-[clamp(2.5rem,6vw,6rem)]">
          ...
          >
            <span ref={line1Ref} className="block cursor-default select-none">Rushikesh</span>
            <span ref={line2Ref} className="block cursor-default select-none">Dhuri</span>
          </h1>
          ...
          >
            Filmmaker | Film Editor | Director crafting compelling stories through the art of editing and visual narrative.
          </p>
      ...
      <div className="absolute right-[clamp(1rem,2vw,2.5rem)] top-1/2 -translate-y-1/2 hidden lg:flex flex-col items-center gap-3 z-10">
        <span
          ...
          style={{ fontFamily: 'Satoshi, system-ui, sans-serif' }}
        >
          Filmmaking · Editing · Direction · Mumbai
        </span>
      </div>
    </section>
  );
