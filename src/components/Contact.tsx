...
const SOCIALS = [
  ...
  },
  {
    ...
    svg: (
      <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
        <path d="M17.8 21.4H6.2c-2 0-3.6-1.6-3.6-3.6V6.2c0-2 1.6-3.6 3.6-3.6h11.6c2 0 3.6 1.6 3.6 3.6v11.6c0 2-1.6 3.6-3.6 3.6zM7.2 9.2v5.6h1.4V9.2H7.2zm7.8 0h-2.6l-1 3.4-1-3.4H7.8v5.6h1.4v-4l1.2 4h1.2l1.2-4v4h1.4V9.2zm2.8 0h-1.4v5.6h1.4V9.2z" />
      </svg>
    ),
  },
  {
    label: 'Email',
    href: 'mailto:rushikeshdhuri88@gmail.com',
    svg: (
      <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
        <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm-.8 2L12 10.8 4.8 6h14.4zM4 18V7.8l7.5 5.2c.3.2.7.2 1 0L20 7.8V18H4z" />
      </svg>
    ),
  },
];
        ...
        <footer className="border-t border-white/6 mt-0 relative z-10 overflow-hidden">
          ...
          <div className="relative z-10 max-w-360 mx-auto px-[clamp(1.25rem,5vw,5rem)] py-[clamp(3rem,5vw,5rem)]">
            ...
            <div className="flex flex-col items-center sm:flex-row sm:items-center sm:justify-between gap-6 sm:gap-8 mb-10 sm:mb-12">
              ...
              >
                <Image
                src="/logo/cybersage_icon.png"
                alt="TheCybersage"
                width={38}
                height={38}
                className="opacity-40 hover:opacity-70 transition-opacity duration-300 rounded-full"
                />
              </motion.div>
            ...
            >
              <p
                ...
                style={{ fontFamily: 'Satoshi, system-ui, sans-serif' }}
              >
                © 2026 Rushikesh Dhuri · TheCybersage
              </p>
              <p
