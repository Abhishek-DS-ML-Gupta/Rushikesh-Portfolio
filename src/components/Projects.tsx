...
const PROJECTS = [
  {
    ...
    category: 'Disney+ Hotstar Specials',
    tagline: 'Assistant Editor — 3 Episodes. Teaser and series created by acclaimed director Milan Luthria. Distributed on Disney+ Hotstar.',
    stack: ['Assistant Editor', 'Web Series', 'Disney+ Hotstar'],
  ...
  },
  {
    ...
    name: 'Hi Aatir',
    category: 'Short Film',
    tagline: 'Assistant Editor. Story & Direction by Anish Bansod. Starring Pranit Phutane and Anish Bansod. Produced by Arun Kumar Bansod & Bhawana Bansod. DOP Diksha Agrawal, Editor Joshua George John, Music by Alen Thomas. Streaming on the Ikon Play OTT Platform.',
    stack: ['Assistant Editor', 'Short Film', 'Ikon Play'],
    image: '/projects/project1.jpeg',
    year: '2023',
  },
  {
    id: 'problem-child',
    name: 'Problem Child (शैतान बालक)',
    category: 'Student Academy Award Nominated',
    tagline: 'Editor. Written & Directed by Shawn Divakar. Produced by Sidhant Rajeshirke & Stuti Rai. Cast: Vivek Chawan, Veer Gaikwad, Sumukha Prasad, Disha Raj Gaurav. DOP Arjun Thaper, Sound Designer Aryam Singh, Original Score by Varun Sanmitra. Nominated for the Student Academy Award (Narrative | Domestic Film Schools).',
    stack: ['Editor', 'Narrative Film', 'Award Nominated'],
    image: '/projects/project2.jpeg',
    year: '2023',
  },
  {
    id: 'gangs-of-gaziyabad',
    name: 'Gangs of Gaziyabad',
    category: 'Unreleased Series',
    tagline: 'Assistant Editor — All Episodes. Produced by Suman Talkies Pvt Ltd.',
    stack: ['Assistant Editor', 'Series'],
  ...
  },
  {
    id: 'chingam',
    name: 'Chingam',
    category: 'Festival Feature Film',
    tagline: 'Associate Editor. Produced by Verse Studio 18 / 8x8 Entertainment.',
    stack: ['Associate Editor', 'Feature Film'],
  ...
  },
  {
    ...
    tagline: 'Songs Editor. Produced by Bharat Gupta Films.',
    stack: ['Songs Editor', 'Feature Film'],
  ...
  },
  {
    ...
    name: 'Kanyadaan',
    category: 'Feature Film',
    tagline: 'Assistant Editor. Independent Production.',
    stack: ['Assistant Editor', 'Feature Film'],
  ...
  },
  {
    ...
    name: 'Imaam',
    category: 'Short Film',
    tagline: 'Associate Editor. A Mumtaz Saba Creation.',
    stack: ['Associate Editor', 'Short Film'],
  ...
  },
  {
    ...
    tagline: 'Teaser & Trailer Editor. Splash Film Pvt. Ltd.',
    stack: ['Editor', 'Teaser', 'Trailer'],
    image: '/projects/project8.jpeg',
    year: '2022',
  },
  {
    id: 'short-films-commercials',
    name: 'Short Films, Commercials & Streaming',
    category: 'Editor / Associate',
    tagline: 'Vasudev (Editor), Bura Mano micro drama (Editor, Cardboard Films), 10 Short Films (Assistant Editor, Whistling Woods Entertainment), Uninvited Horror (Associate Editor, 8x8 Entertainment), and 20+ advertising & client campaigns including Amazon (58miles), Kem Hospital, Home First Finance, and PMAY.',
    stack: ['Editor', 'Commercials', 'Streaming'],
          ...
          >
            {([0, 1, 2, 3, 4, 5] as const).map((fi) => {
              ...
              return (
                ...
                >
                  {(() => {
                    const projectIdx = faceImages[fi];
                    if (projectIdx === null || projectIdx === undefined) return null;
                    return (
                      <>
                        <Image
                          src={PROJECTS[projectIdx].image}
                          alt={PROJECTS[projectIdx].name}
                          fill
